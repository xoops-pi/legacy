...
if ( $op == "form" ) {
    ...
    $form = new XoopsThemeForm(_AM_FINDUS, "uesr_findform", "users.php", 'post', true);
...
elseif ($op == "submit") {
    ...
    echo "<a href='users.php?op=form'>". _AM_FINDUS ."</a>&nbsp;<span style='font-weight:bold;'>&raquo;&raquo;</span>&nbsp;". _AM_RESULTS."<br /><br />";
    if ( $total == 0 ) {
