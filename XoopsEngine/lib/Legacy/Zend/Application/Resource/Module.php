...
class Legacy_Zend_Application_Resource_Module extends Zend_Application_Resource_ResourceAbstract
{
    public function init()
    {
        global $xoopsModule, $xoopsUser, $xoopsModuleConfig, $module_handler;

        if (file_exists('./xoops_version.php') || file_exists('../xoops_version.php')) {
