...
class Legacy_Zend_Application_Resource_Frontcontroller extends Zend_Application_Resource_Frontcontroller
{
    /**
    ...
    public function init()
    {
        ...
        $dispatcherClass = "Legacy_Zend_Controller_Dispatcher_Raw";
    ...
    {
        if (null === $this->_front) {
            $this->_front = Legacy_Zend_Controller_Front::getInstance();
            XOOPS::registry('frontController', $this->_front);
        }
        return $this->_front;
    }
}
